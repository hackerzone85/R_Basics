...
bwplot(log(Fatalities)~Phase, data = AirCrash
       , varwidth = TRUE
       , par.settings = MyLatticeTheme)

bwplot(log(Fatalities)~Cause, data = AirCrash
       , varwidth = TRUE
       , par.settings = MyLatticeTheme)
...
*There is definitely a structured association between Year and the other two predictors.*

```{r, fig.height=4, fig.width=4.5, eval = FALSE}
spine(Phase~Year, data = AirCrash
       , xlab = "Year", yaxlabels = ""
       , main = "Phase by Year Spinogram")
spine(Cause~Year, data = AirCrash
       , xlab = "Year", yaxlabels = ""
       , main = "Phase by Year Spinogram")
```
...
plot(allEffects(ac.glm), band.colors = "blue", lwd = 3,
...
plot(allEffects(ac.glm2), band.colors = "blue", lwd = 3,
     ylab = "Number of articles", main = "")
```
