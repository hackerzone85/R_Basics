...
The main trend lines were added using a hurdle model. Traditional linear models would be dragged downwards on the Y axis by the prevalence of zeros in the data, giving too low an estimate. The hurdle is robust to this type of data.
...
Hiere is the international data fitted with linear negative binomial, hurdle and zero-inflated poisson models:
